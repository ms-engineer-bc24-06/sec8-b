...
# データベースセッションの取得：データベースの操作を行うためのセッション: services/get_user_conversation/pyに切り出してエラー処理を加筆
...
def generate_prompt_with_history(drug_name: str, info_type: str, pmda_url: str, user_id: str) -> str:
    ...
    # services/get_user_conversation.pyからimportして会話履歴取得処理を実行
